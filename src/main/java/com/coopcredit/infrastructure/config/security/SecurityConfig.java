    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/v1/affiliates/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/affiliates/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/v1/affiliates/**").hasAnyRole("ADMIN", "ANALISTA")
                        .requestMatchers(HttpMethod.POST, "/api/v1/credit-applications").hasAnyRole("AFILIADO", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/v1/credit-applications/pending")
                        .hasAnyRole("ANALISTA", "ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/v1/credit-applications/*/evaluate")
                        .hasAnyRole("ANALISTA", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/v1/credit-applications/affiliate/**")
                        .hasAnyRole("AFILIADO", "ADMIN")
